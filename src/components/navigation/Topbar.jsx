...
export default function Topbar({ onToggleSidebar }) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 border-b border-slate-200 bg-white px-3 md:left-[200px] md:w-[calc(100%-200px)]" style={{ height: 72 }}>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-full bg-slate-100 px-2.5 py-1 text-[12px] font-medium text-slate-600">2026-27</span>
            </div>
          </div>
        </div>
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              <div className="min-w-0">
                ...
                <p className="text-[11px] text-slate-500">Nice to have you back!</p>
              </div>
