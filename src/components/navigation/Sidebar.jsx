...
const links = [
  ...
  { label: 'Fees', to: '/fees', icon: Wallet, moduleKey: 'fees' },
  { label: 'Teachers', to: '/teachers', icon: School, moduleKey: 'teachers' },
  { label: 'Employees', to: '/employees', icon: Briefcase, moduleKey: 'employees' },
  { label: 'Leave Management', to: '/leave-management', icon: CalendarCheck, moduleKey: 'leaveManagement' },
  { label: 'Payroll Management', to: '/payroll-management', icon: Wallet, moduleKey: 'payroll' },
  { label: 'Finance & Accounting', to: '/finance-accounting', icon: BarChart3, moduleKey: 'finance' },
  { label: 'Designations', to: '/designations', icon: Award, moduleKey: 'designations' },
  { label: 'Organizations', to: '/organizations', icon: Building, moduleKey: 'organizations' },
  { label: 'HR Documents', to: '/hr-documents', icon: FileText, moduleKey: 'hrDocuments' },
  ...
  { label: 'Procurement Center', to: '/inventory', icon: ShoppingCart, moduleKey: 'inventory' },
  ...
  { label: 'Result Processing', to: '/result-processing', icon: Database, moduleKey: 'resultProcessing' },
