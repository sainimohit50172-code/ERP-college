export default function InfoCard({ title, value, description, icon, accent }) {
  ...
  return (
    <div className="hover-gradient-border rounded-[18px] border border-slate-200/70 bg-white/95 p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg cursor-pointer" style={{ '--hover-gradient-radius': '14px' }}>
