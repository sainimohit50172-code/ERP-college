        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="grid gap-4 xl:grid-cols-2">
            <div className="rounded-[22px] border border-slate-200/80 bg-white p-5 shadow-[0_18px_50px_-26px_rgba(15,23,42,0.28)]">
              ...
              <div className="mt-4 flex min-h-[250px] items-center justify-center rounded-[18px] border border-dashed border-slate-300 bg-slate-50/80 p-5">
          ...
          <div className="grid gap-4 xl:grid-cols-[1.5fr_1fr]">
            <div className="rounded-[22px] border border-slate-200/80 bg-white p-5 shadow-[0_18px_50px_-26px_rgba(15,23,42,0.28)]">
              ...
              <div className="mb-4 flex gap-2">
                <select className="flex-1 rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm">
            ...
            <div className="rounded-[22px] border border-slate-200/80 bg-white p-5 shadow-[0_18px_50px_-26px_rgba(15,23,42,0.28)]">
              ...
              <select className="mb-4 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm">
                <option>Select installments</option>
              </select>
              <TopDefaulters />
            </div>
