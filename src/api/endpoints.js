const endpoints = {
  ...
  libraryIssues: 'library-issues',
  libraryFines: 'library-fines',
  libraryReservations: 'library-reservations',
  libraryRenewals: 'library-renewals',
  libraryLosses: 'library-losses',
  libraryDamages: 'library-damages',
  hostels: 'hostels',
