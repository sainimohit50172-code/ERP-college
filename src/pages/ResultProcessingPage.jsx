    ...
    <div className="space-y-6">
      ...
      <Modal title="Process result" isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} footer={<button onClick={handleSubmit(onSubmit)} className="rounded-3xl bg-sky-400 px-5 py-3 text-sm font-semibold text-slate-950 transition hover:bg-sky-300">Process result</button>}>
        <form className="grid gap-5 lg:grid-cols-2">
          ...
          <FormField label="Internal marks (out of 50)"><input type="number" min="0" max="50" {...register('internal')} className="w-full rounded-3xl border border-white/10 bg-slate-900/80 px-4 py-3 text-slate-100 outline-none focus:border-sky-400" placeholder="42" /></FormField>
          <FormField label="Practical marks (out of 50)"><input type="number" min="0" max="50" {...register('practical')} className="w-full rounded-3xl border border-white/10 bg-slate-900/80 px-4 py-3 text-slate-100 outline-none focus:border-sky-400" placeholder="42" /></FormField>
          <FormField label="External marks (out of 100)"><input type="number" min="0" max="100" {...register('external')} className="w-full rounded-3xl border border-white/10 bg-slate-900/80 px-4 py-3 text-slate-100 outline-none focus:border-sky-400" placeholder="68" /></FormField>
