...
export default function AdmissionsPage() {
  ...
  return (
    <div className="space-y-8">
      <section className="rounded-[32px] border border-white/10 bg-slate-900/80 p-8 shadow-soft backdrop-blur-xl">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          <div className="rounded-3xl border border-white/10 bg-slate-950/60 p-5 text-slate-200 shadow-sm">
            <div className="flex items-center gap-3 text-sky-300"><FaUserPlus /><span className="text-sm uppercase">New applications</span></div>
            <p className="mt-3 text-3xl font-semibold">{metrics.newApplications}</p>
          </div>
          <div className="rounded-3xl border border-white/10 bg-slate-950/60 p-5 text-slate-200 shadow-sm">
            ...
            <p className="mt-3 text-3xl font-semibold">{metrics.offersSent}</p>
          </div>
          <div className="rounded-3xl border border-white/10 bg-slate-950/60 p-5 text-slate-200 shadow-sm">
            <div className="flex items-center gap-3 text-violet-300"><FaUserPlus /><span className="text-sm uppercase">Enrolled</span></div>
            <p className="mt-3 text-3xl font-semibold">{metrics.enrolled}</p>
          </div>
          <div className="rounded-3xl border border-white/10 bg-slate-950/60 p-5 text-slate-200 shadow-sm">
            ...
            <p className="mt-3 text-3xl font-semibold">{metrics.pendingDocuments}</p>
          </div>
        </div>
      </section>
