    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-[28px] border border-white/10 bg-slate-900/80 p-6 shadow-sm">
          <p className="text-sm uppercase tracking-[0.24em] text-slate-400">Total events</p>
          <p className="mt-4 text-3xl font-semibold text-white">{totalEvents}</p>
        </div>
        <div className="rounded-[28px] border border-white/10 bg-slate-900/80 p-6 shadow-sm">
          <p className="text-sm uppercase tracking-[0.24em] text-slate-400">Examinations</p>
          <p className="mt-4 text-3xl font-semibold text-white">{examinations}</p>
        </div>
        <div className="rounded-[28px] border border-white/10 bg-slate-900/80 p-6 shadow-sm">
          <p className="text-sm uppercase tracking-[0.24em] text-slate-400">Holidays</p>
          <p className="mt-4 text-3xl font-semibold text-white">{holidays}</p>
        </div>
      </div>
      ...
      <div className="rounded-[32px] border border-white/10 bg-slate-900/80 p-6 shadow-soft">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2"><SearchFilter search={search} onSearch={setSearch} filter={filter} onFilter={setFilter} options={eventTypeOptions} placeholder="Search events..." /></div>
