...
const setupCards = [
  ...
  { title: 'Courses', description: 'Courses and Streams', icon: Monitor },
  { title: 'Transport', description: 'Transport Section', icon: Bus },
  { title: 'Hostel', description: 'Hostel Section', icon: Building },
  { title: 'Attendance', description: 'Attendance Section', icon: CalendarCheck },
  { title: 'Institute Preference', description: 'Preference Section', icon: Settings2 },
  { title: 'Student Fields', description: 'Preference Section', icon: UsersRound },
  { title: 'Student Master Setup', description: 'Student Master Setup', icon: GraduationCap },
