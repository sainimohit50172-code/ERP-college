...
import { FaCalendarDay, FaDownload, FaSearch, FaUsers } from 'react-icons/fa';
...
export default function TeacherAttendancePage() {
  const { data, isLoading } = useResourceList('teacherAttendance', { page: 1, pageSize: 200 });
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.35fr_0.65fr]">
        ...
        <div className="rounded-[32px] border border-white/10 bg-slate-900/80 p-6 shadow-soft"><div className="mb-5 flex items-center gap-3"><div className="flex h-12 w-12 items-center justify-center rounded-3xl bg-slate-700/80 text-slate-200"><FaCalendarDay className="h-5 w-5" /></div><div><p className="text-sm uppercase tracking-[0.24em] text-slate-400">Attendance entry</p><h3 className="text-xl font-semibold text-white">Log faculty attendance</h3></div></div>
