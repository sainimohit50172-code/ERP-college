...
export default function EmployeeProfilePage() {
  ...
  return (
    <div className="space-y-3 p-2 sm:space-y-6 sm:p-4 lg:p-6 md:space-y-5 md:p-5">
      ...
      <input ref={uploadInputRef} type="file" accept=".pdf,.jpg,.png,.jpeg,.doc,.docx" className="hidden hover-gradient-border" onChange={handleDocumentInputChange} />
      ...
      <Modal
        ...
        footer={
          <button
            ...
            className="w-full rounded-3xl bg-emerald-500 px-4 py-2 text-xs font-semibold text-slate-950 transition hover:bg-emerald-400 sm:w-auto sm:px-5 sm:py-3 sm:text-sm hover-gradient-border"
          >
            Save status
          </button>
        }
