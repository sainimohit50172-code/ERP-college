  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <div className="rounded-[28px] border border-white/10 bg-slate-900/80 p-6 shadow-sm">
          <p className="text-sm uppercase tracking-[0.24em] text-slate-400">Open</p>
          <p className="mt-4 text-3xl font-semibold text-white">{openAssignments}</p>
        </div>
        <div className="rounded-[28px] border border-white/10 bg-slate-900/80 p-6 shadow-sm">
          <p className="text-sm uppercase tracking-[0.24em] text-slate-400">Closed</p>
          <p className="mt-4 text-3xl font-semibold text-white">{closedAssignments}</p>
        </div>
      </div>
      ...
      <div className="rounded-[32px] border border-white/10 bg-slate-900/80 p-6 shadow-soft">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          <div>
            <h2 className="text-xl font-semibold text-white">Assignment library</h2>
