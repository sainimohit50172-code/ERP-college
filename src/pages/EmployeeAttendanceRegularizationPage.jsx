...
export default function EmployeeAttendanceRegularizationPage() {
  ...
  return (
    <div className="h-[calc(100vh-88px)] overflow-x-hidden bg-[#F8FAFC] px-4 py-4 font-sans md:px-6 md:py-6">
      <div className="flex h-full flex-col overflow-hidden">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <h1 className="mt-3 text-xl font-bold text-slate-900 sm:text-2xl md:text-3xl">Employee Attendance Regularization</h1>
          </div>
          <button
            type="button"
            onClick={() => setShowModal(true)}
            className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-[#1E293B] px-4 py-3 text-sm font-semibold text-white transition hover:bg-slate-800 sm:w-auto"
          >
            <Plus size={16} />
            Add New
          </button>
        ...
        <div className="mt-5 flex flex-col gap-4">
          ...
          <div className="rounded-xl border border-[#E2E8F0] bg-white p-4 shadow-sm">
            <div className="flex flex-col gap-3 md:flex-row md:flex-wrap md:items-end md:gap-4">
              <div className="w-full min-w-0 md:min-w-[180px] md:flex-1">
