      ...
      <div className="grid gap-6 xl:grid-cols-[1.35fr_0.65fr]">
        <div className="grid gap-6">
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-[28px] border border-white/10 bg-slate-900/80 p-6 shadow-sm"><p className="text-sm uppercase tracking-[0.24em] text-slate-400">Guards on duty</p><p className="mt-4 text-3xl font-semibold text-white">4</p></div>
        ...
        <div className="rounded-[18px] border border-white/10 bg-slate-900/80 p-4 shadow-sm"><div className="mb-5 flex items-center gap-3"><div className="flex h-12 w-12 items-center justify-center rounded-3xl bg-slate-700/80 text-slate-200"><FaShieldAlt className="h-5 w-5" /></div><div><p className="text-sm uppercase tracking-[0.24em] text-slate-400">Manual log</p><h3 className="text-xl font-semibold text-white">Record guard attendance</h3></div></div>
          <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <FormField label="Post"><input type="text" {...register('post', { required: true })} className="w-full rounded-3xl border border-white/10 bg-slate-900/80 px-4 py-3 text-slate-100 outline-none focus:border-sky-400" placeholder="Main Gate" /></FormField>
