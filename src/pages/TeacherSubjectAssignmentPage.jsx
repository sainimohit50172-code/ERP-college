...
export default function TeacherSubjectAssignmentPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <Modal title="Assign teacher to subject" isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} footer={<button onClick={handleSubmit(onSubmit)} className="rounded-3xl bg-sky-400 px-5 py-3 text-sm font-semibold text-slate-950 transition hover:bg-sky-300">Save assignment</button>}>
        <form className="grid gap-5 lg:grid-cols-2">
          ...
          <FormField label="Subject"><select {...register('subjectCode', { required: 'Subject code is required' })} className="w-full rounded-3xl border border-white/10 bg-slate-900/80 px-4 py-3 text-slate-100 outline-none focus:border-sky-400">
          ...
          <FormField label="Theory hours/week"><input type="number" {...register('theoryHours', { required: 'Theory hours is required' })} className="w-full rounded-3xl border border-white/10 bg-slate-900/80 px-4 py-3 text-slate-100 outline-none focus:border-sky-400" placeholder="3" />{errors.theoryHours && <p className="mt-1 text-sm text-rose-400">{errors.theoryHours.message}</p>}</FormField>
          ...
          <FormField label="Lead teacher"><select {...register('isLead')} className="w-full rounded-3xl border border-white/10 bg-slate-900/80 px-4 py-3 text-slate-100 outline-none focus:border-sky-400"><option value={true}>Yes</option><option value={false}>No</option></select></FormField>
