...
const cards = [
  ...
  {
    title: 'Exam Form Headers / Footers',
    subtitle: 'Exam Form Headers / Footers Setup',
    icon: FileText,
    route: '/coe/master/exam-form-preferences/header-footer',
  },
];

export default function ExamFormPreferencesLandingPage() {
  return (
      ...
      <div className="no-hover-border flex h-full flex-col rounded-[22px] border border-slate-200/70 bg-white/90 p-3 shadow-inner sm:p-4 lg:p-5">
        <div className="coe-page-content-top mb-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <h1 className="text-3xl font-semibold tracking-tight text-slate-950">Exam Form Preferences</h1>
            <p className="max-w-2xl text-sm text-slate-500">Select an exam form configuration area.</p>
          </div>
        </div>
