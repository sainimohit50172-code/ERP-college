...
class CoeMaskingNumberSetupDetail(BaseModel):
...
class CoeMaskingNumberSetupCreate(BaseModel):
    model_config = ConfigDict(from_attributes=True, populate_by_name=True)
    ...
    def validate_numbers(self) -> "CoeMaskingNumberSetupCreate":
...
class CoeMaskingNumberSetupUpdate(BaseModel):
    model_config = ConfigDict(from_attributes=True, populate_by_name=True)
    ...
    @model_validator(mode="after")
    def validate_numbers(self) -> "CoeMaskingNumberSetupUpdate":
